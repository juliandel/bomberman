...
public class Engine {
	...
	public void inicializarVentana(){
		...
		addTexturas("ex", new Textura("assets\\graficos\\bomberman1\\tiles\\explotable16x16.png"));

		//addTexturas("bl", new Textura("assets/graficos/bomberman1/tiles/bloqueado.png"));
		
		for (int i = 0; i < 1; i++) {
			Tile t = new Tile(true, true, new Sprite("ex", false),100,100);		
	...
	public void cargarTexturas(String set){
		//personajes
		addTexturas("p1n", new Textura(set+"personaje\\P1 - CELESTE\\norte.png"));
		addTexturas("p1s", new Textura(set+"personaje\\P1 - CELESTE\\sur.png"));
		addTexturas("p1e", new Textura(set+"personaje\\P1 - CELESTE\\este.png"));
		addTexturas("p1o", new Textura(set+"personaje\\P1 - CELESTE\\oeste.png"));
		addTexturas("p1m", new Textura(set+"personaje\\P1 - CELESTE\\muerte.png"));
